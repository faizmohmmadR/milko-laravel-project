...
<h3 style="text-align: center;">Add Customer</h3>
  ...
  @method('PUT')
     ...
     <div class="mb-3">
         ...
         <select name="customerType" value="{{$customers->customerType}}" id="">
     ...
     <div class="mb-3">
         <label for="exampleInputPassword1" class="form-label">Update Customer</label>
         <select name="customerAddress" value="{{$customers->customerAddress}}" id="">
     ...
     <div class="mb-3">
         ...
         <select name="branch" value="{{$customers->branch}}" id="">
